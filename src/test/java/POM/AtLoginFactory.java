...
public class AtLoginFactory extends ClsWebElements{
	...
	public void enterCredential() 
	{
		...
		new WebDriverWait(ClsWebElements.objDriver, 10).until(ExpectedConditions.elementToBeClickable(NextBtn));
		NextBtn.click();
	}
	...
	{
		WaitForLoad();
		new WebDriverWait(ClsWebElements.objDriver, 10).until(ExpectedConditions.elementToBeClickable(StartSessionBtn));
